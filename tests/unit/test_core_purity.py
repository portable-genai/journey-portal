...
The dynamic blocked-import probe (``tests/_sdk_free_probe.py``) proves every profile binds
with the SDK unimportable; this static scan additionally catches a lazy
